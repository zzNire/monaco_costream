...
import {costream as monarchObj} from '../js/costream.js'
import 'monaco-editor/esm/vs/basic-languages/javascript/javascript.contribution';
import {rule} from '../js/costream_theme.js'
export default {
    mounted() {
        
        monaco.languages.register({id:'costream'});
        monaco.languages.setMonarchTokensProvider('costream', monarchObj);
        monaco.editor.defineTheme('costreamTheme', {
            base:'vs-dark',
            inherit:true,
            rules:rule
        })
